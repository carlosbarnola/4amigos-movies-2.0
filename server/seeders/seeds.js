...
db.once('open', async () => {
 ...
 for (let i = 0; i < 50; i += 1) {
   ...
   const movieTitle = faker.commerce.productName();
   const movieUrl = faker.internet.url
   ...
   // store the movies
   movieData.push({ externalMovieId, rating, voteCount, movieTitle, movieUrl, overview, releaseDate, poster, trailer });
 }
